...
namespace AtomDpi.Core.Startup;
...
{
    public const string TaskName = "AtomDpiBypass-Autostart";
    private const string RunKeyPath = @"SOFTWARE\Microsoft\Windows\CurrentVersion\Run";
    private const string RunValueName = "AtomDpiBypass";
    ...
    public async Task<bool> EnableAsync(bool startMinimised, CancellationToken cancellationToken = default)
    {
        ...
        var xmlPath = Path.Combine(Path.GetTempPath(), $"atomdpi-task-{Guid.NewGuid():N}.xml");
