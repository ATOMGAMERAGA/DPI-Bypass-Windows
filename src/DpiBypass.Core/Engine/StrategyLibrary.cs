...
/// <see cref="DpiBypass.Core.Network.IspProfile"/> decides which ones get tried
...
public static class StrategyLibrary
{
    ...
    /// <summary>
    /// Every strategy the tuner may pick, in a sensible default order: the ones that
    /// cost no latency come first, the ones that wait on a retransmission come last.
    /// </summary>
